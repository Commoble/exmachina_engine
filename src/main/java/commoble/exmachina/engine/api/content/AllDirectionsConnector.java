...
public enum AllDirectionsConnector implements Connector
{
	...
	public static final ResourceKey<Codec<? extends Connector>> KEY = ResourceKey.create(ExMachinaRegistries.CONNECTOR_TYPE, ExMachinaEngine.exMachinaRl(Names.ALL_DIRECTIONS));
